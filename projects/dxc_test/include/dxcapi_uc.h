...
CROSS_PLATFORM_UUIDOF(IDxcRewriteResult, "CEDB484A-D4E9-445A-B991-CA21CA157DC2")
struct IDxcRewriteResult : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE GetStatus(uint32_t* pResult) = 0;
    virtual HRESULT STDMETHODCALLTYPE GetRewrite(IDxcBlobEncoding** pResult) = 0;
    virtual HRESULT STDMETHODCALLTYPE GetErrorBuffer(IDxcBlobEncoding** pResult) = 0;
};
...
CLSID_SCOPE const CLSID CLSID_DxcRewriter = {
  0xb489b951,
  0xe07f,
  0x40b3,
